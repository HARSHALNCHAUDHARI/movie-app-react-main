...
const About = () => {
  return (
    ...
    <div className="card-content">
      ...
      <p className='about__p'>Hello from Harshal!! I am too glad you visited my website. This is just a chill weekend project by me to find movies by search term. Don't forget to give a kiss to Sush now! 😁</p>
    </div>
  </div>
  );
};
